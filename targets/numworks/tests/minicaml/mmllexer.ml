...
let __ocaml_lex_tables = {
  ...
  Mylexing.lex_check =
   "\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    ...
    \255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\255\
    ";
  Mylexing.lex_base_code =
   "";
  Mylexing.lex_backtrk_code =
   "";
  Mylexing.lex_default_code =
   "";
  Mylexing.lex_trans_code =
   "";
  Mylexing.lex_check_code =
   "";
  Mylexing.lex_code =
   "";
}
...
and __ocaml_lex_token_rec lexbuf __ocaml_lex_state =
  match Mylexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 44 "lib/mmllexer.mll"
...
# 47 "lib/mmllexer.mll"
              n
# 184 "lib/mmllexer.ml"
= Mylexing.sub_lexeme lexbuf lexbuf.Mylexing.lex_start_pos lexbuf.Mylexing.lex_curr_pos in
# 47 "lib/mmllexer.mll"
                  ( CST(int_of_string n) )
# 188 "lib/mmllexer.ml"
...
# 308 "lib/mmllexer.ml"
  ...
  | __ocaml_lex_state -> lexbuf.Mylexing.refill_buff lexbuf;
